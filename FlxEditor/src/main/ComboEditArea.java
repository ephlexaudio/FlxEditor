...
public class ComboEditArea {
	...
	ComboEditArea()
	{
		...
		updateButton.setOnMouseClicked(event->{
			...
			{
				this.drawingAreaReference.setNames(names.get(0), names.get(1), names.get(2), names.get(3), names.get(4));
...
//		AnchorPane.setRightAnchor(comboEditGridPane, 50.0);
//		AnchorPane.setBottomAnchor(comboEditGridPane, 50.0);
	...
	public void clearNames()
	{
		...
		this.comboNameText.clear();// = new TextField();
		this.effect0NameText.clear();// = new TextField();
		this.effect0AbbrText.clear();// = new TextField();
		this.effect1NameText.clear();// = new TextField();
		this.effect1AbbrText.clear();// = new TextField();
	}
