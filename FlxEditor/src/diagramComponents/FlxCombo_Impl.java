...
public class FlxCombo_Impl implements FlxCombo {
	...
	List<JsonValue> effectDataArray;
	List<JsonValue> effectConnectionDataArray;
	Map<String,FlxEffect> effectMap;
	Map<String,FlxCord> effectConnectionMap;
	...
	public FlxCombo_Impl(JsonValue comboJsonData)
	{
		try
		{
			...
			try
			{
				this.effectDataArray = comboJsonObject.getJsonArray("effectArray");
				success = true;
			}
			catch(Exception e)
			{
